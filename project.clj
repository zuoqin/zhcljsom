(defproject zhcljsom "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "zhcljsom.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main zhcljsom.server
  ...
  :cljsbuild {:builds
              {:app
               {:source-paths ["src/cljs"]
                ...
                ;; :figwheel {:on-jsload "zhcljsom.core/on-figwheel-reload"}

                :compiler {:main zhcljsom.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/zhcljsom.js"
